...
module sub_board_controller(
	...
	assign board_outline = 	(hCount >= x_offset) && (hCount < x_offset + 120) &&
							(vCount >= y_offset) && (vCount < y_offset + 120);
	
	// Grid Line Definitions
	assign board_v_line_1 = (hCount >= 32 + x_offset) && 	(hCount <= 34 + x_offset) && 
							(vCount >= 0 + y_offset) && 		(vCount <= 100 + y_offset);
	assign board_v_line_2 = (hCount >= 66 + x_offset) && 	(hCount <= 68 + x_offset) && 
							(vCount >= 0 + y_offset) && 		(vCount <= 100 + y_offset);
	assign board_h_line_1 = (hCount >= 0 + x_offset) && 		(hCount <= 100 + x_offset) && 
							(vCount >= 32 + y_offset) && 	(vCount <= 34 + y_offset);
	assign board_h_line_2 = (hCount >= 0 + x_offset) && 		(hCount <= 100 + x_offset) && 
							(vCount >= 66 + y_offset) && 	(vCount <= 68 + y_offset);
	
		// cell background row 0
	assign board_cell_background_0_0 = 	(hCount >= 0 + x_offset) && 	(hCount <= 32 + x_offset) && 
										(vCount >= 0 + y_offset) && 	(vCount <= 32 + y_offset);
	assign board_cell_background_1_0 = 	(hCount >= 34 + x_offset) && 	(hCount <= 66 + x_offset) && 
										(vCount >= 0 + y_offset) && 	(vCount <= 34 + y_offset);
	assign board_cell_background_2_0 = 	(hCount >= 68 + x_offset) && 	(hCount <= 100 + x_offset) && 
										(vCount >= 0 + y_offset) && 	(vCount <= 32 + y_offset);
 
	// cell background row 1
	assign board_cell_background_0_1 = 	(hCount >= 0 + x_offset) && 	(hCount <= 32 + x_offset) && 
										(vCount >= 34 + y_offset) && 	(vCount <= 66 + y_offset);
	assign board_cell_background_1_1 = 	(hCount >= 34 + x_offset) && 	(hCount <= 66 + x_offset) && 
										(vCount >= 34 + y_offset) && 	(vCount <= 66 + y_offset);
	assign board_cell_background_2_1 = 	(hCount >= 68 + x_offset) && 	(hCount <= 100 + x_offset) && 
										(vCount >= 34 + y_offset) && 	(vCount <= 66 + y_offset);
 
	// cell background row 2
	assign board_cell_background_0_2 = 	(hCount >= 0 + x_offset) && 	(hCount <= 32 + x_offset) && 
										(vCount >= 68 + y_offset) && 	(vCount <= 100 + y_offset);
	assign board_cell_background_1_2 = 	(hCount >= 34 + x_offset) && 	(hCount <= 66 + x_offset) && 
										(vCount >= 68 + y_offset) && 	(vCount <= 100 + y_offset);
	assign board_cell_background_2_2 = 	(hCount >= 68 + x_offset) && 	(hCount <= 100 + x_offset) && 
										(vCount >= 68 + y_offset) && 	(vCount <= 100 + y_offset);
 
	// Cell Inner Area Definitions (with padding)
	// cell row 0
	assign cell_0_0 = 	(hCount >= (0   + x_offset + padding)) && 
						(hCount <= (32 + x_offset - padding)) && 
						(vCount >= (0   + y_offset + padding)) && 
						(vCount <= (32 + y_offset - padding));
	assign cell_1_0 = 	(hCount >= (34 + x_offset + padding)) && 
						(hCount <= (66 + x_offset - padding)) && 
						(vCount >= (0   + y_offset + padding)) && 
						(vCount <= (32 + y_offset - padding));
	assign cell_2_0 = 	(hCount >= (68 + x_offset + padding)) && 
						(hCount <= (100 + x_offset - padding)) && 
						(vCount >= (0   + y_offset + padding)) && 
						(vCount <= (32 + y_offset - padding));
	...
	assign cell_0_1 = 	(hCount >= (0 + x_offset + padding)) && 
						(hCount <= (32 + x_offset - padding)) && 
						(vCount >= (34 + y_offset + padding)) && 
						(vCount <= (66 + y_offset - padding));
	assign cell_1_1 = 	(hCount >= (34 + x_offset + padding)) && 
						(hCount <= (66 + x_offset - padding)) && 
						(vCount >= (34 + y_offset + padding)) && 
						(vCount <= (66 + y_offset - padding));
	assign cell_2_1 = 	(hCount >= (68 + x_offset + padding)) && 
						(hCount <= (100 + x_offset - padding)) && 
						(vCount >= (34 + y_offset + padding)) && 
						(vCount <= (66 + y_offset - padding));
	...
	assign cell_0_2 = 	(hCount >= (0 + x_offset + padding)) && 
						(hCount <= (32 + x_offset - padding)) && 
						(vCount >= (68 + y_offset + padding)) && 
						(vCount <= (100 + y_offset - padding));
	assign cell_1_2 = 	(hCount >= (34 + x_offset + padding)) && 
						(hCount <= (66 + x_offset - padding)) && 
						(vCount >= (68 + y_offset + padding)) && 
						(vCount <= (100 + y_offset - padding));
	assign cell_2_2 = 	(hCount >= (68 + x_offset + padding)) && 
						(hCount <= (100 + x_offset - padding)) && 
						(vCount >= (68 + y_offset + padding)) && 
						(vCount <= (100 + y_offset - padding));
	...
	always @(posedge clk, posedge rst) begin
		...
		else if (placed) begin
			placed <= 1'b0;
		end
		else if (sub_board_selected) begin
			if (left) begin
				if (cursorX > 0) begin
					cursorX <= cursorX - 1;
	...
	always @(posedge clk) begin
		if (rst) begin
			...
			if (playerA_win && (win_blue != 1'b1 || big_board != 1'b1)) begin
				win_blue <= 1'b1;
				big_board <= 1'b1;
			end
			else if (playerB_win && (win_blue != 1'b1 || big_board != 1'b1)) begin
				win_red <= 1'b1;
				big_board <= 1'b1;
			end
			else if (board_full && board != 1'b1) begin
				big_board<= 1'b1;
			end
		end
	end
