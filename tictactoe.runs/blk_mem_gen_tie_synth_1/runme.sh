...
HD_PWD='C:/Users/Haily.SKUNKWORK/Downloads/EE354_Final_Project/tictactoe.runs/blk_mem_gen_tie_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_tie.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_tie.tcl
